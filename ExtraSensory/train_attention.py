...
parser.add_argument('--save', type=str, default='OpportunitySeparate', help='experiment name')
    ...
    for epoch in range(num_epochs):
        ...
        for data in train_loader:
            ...
            loss_train, performance_train, selected_train = \
                 compute_loss(model, loss, inputs, labels)
            ...
            loss_valid, performance_valid, selected_valid = \
                compute_loss(model, loss, inputs_val, labels_val)
...
if __name__ == "__main__":
    ...
    model = AttentionGRU(num_features, args.n_mult * num_features, num_classes)
