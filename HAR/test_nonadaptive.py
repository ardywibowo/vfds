...
# Settings
parser.add_argument('--gpu', type=float, default=1, help='init learning rate')
parser.add_argument('--weights', type=str, default="Test", help='weight name')
parser.add_argument('--plotting', type=bool, default=False, help='generate plots')
...
if __name__ == "__main__":
    ...
    model = NonadaptiveGRU(input_size, 5 * input_size, num_classes, hard=True)
